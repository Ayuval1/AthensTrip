...
תוכנית יומית:
- שישי 19/6: הגעה 10:00, מזוודות לדירה, צהריים + סופר, ליקאביטוס ערב
- שבת 20/6: ארמו בבוקר, מוזיאון האשליות, אקרופוליס ב-17:00 (כרטיסים לחמש!), פלאקה לאחר
- ראשון 21/6: קלימרמרו → זאפיו → טקס חילופי משמר סינטגמה 11:00 → שוק פשפשים מונסטיראקי
- שני 22/6: הפלגה לאגינה/אגיסטרי מפיראוס (להזמין מראש!)
- שלישי 23/6: XPLORE או מוזיאון אולימפי, טיסה 18:05

אטרקציות עיקריות: אקרופוליס (להזמין ב-eshop.culture.gr, כרטיסים ב-17:00 ביום שבת), מוזיאון האשליות (ליד פלאקה, ~60€ משפחה), ליקאביטוס + פוניקולר (8 דקות מהדירה), סינטגמה + טקס ראשון 11:00, קלימרמרו, שוק פשפשים מונסטיראקי (ראשון), פסירי + Little Kook, גנים זאפיו, XPLORE Golden Hall (~25 דקות נסיעה), מעבורת מפיראוס לאיים.
...
קניות: ארמו Street — זול יותר מישראל. לקנות ביום שבת בבוקר.
